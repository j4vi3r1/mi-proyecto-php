...
<main class="min-h-screen bg-slate-50 py-12 px-6">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="equipos.php" class="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300">
            ...
            <a href="clientes.php" class="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-slate-800 mb-2">Clientes</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Gestión de arriendos activos, devoluciones y cierre de acuerdos comerciales.</p>
            </a>

            <a href="listaFacturas.php" class="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-slate-800 mb-2">Liquidaciones</h3>
